    ...
    <div class="container mt-5">
        ...
        <table class="table table-striped table-hover">
            ...
            <?php foreach ($tabela as $linha) {  ?>
                <tr>
                    <td><?= $linha['id']; ?></td>
                    <td><img src="fotos/<?= $linha['foto']; ?>" alt="Produto 1" width="200px"></td>
                    <td><?= $linha['nome']; ?></td>
                    <td><?= $linha['descricao']; ?></td>
                    <td><?= $linha['nome_categoria']; ?></td>
                    <td><?= $linha['estoque']; ?></td>
                    <td><?= $linha['preco']; ?></td>
                    <td><a class="btn btn-danger" href="#" onclick="confirmaExcluir(<?= $linha['id']; ?>)">Excluir</button></a>
                     <a class="btn btn-warning" href="editar.php?id ">Editar</button></td>
                    <td></td>
                </tr>
                <?php } ?>
